...
# Pod 按指定布局摆放（共 42 个）
ORDERS = [
    # Block 1: (1,1) 往4行x2列 → rows 1-4, cols 1-2
    (1,1,1),(1,2,2),(2,1,3),(2,2,4),(3,1,1),(3,2,2),(4,1,3),(4,2,4),
    # Block 2: (6,1) 往3行x2列 → rows 6-8, cols 1-2
    (6,1,1),(6,2,2),(7,1,3),(7,2,4),(8,1,1),(8,2,2),
    # Block 3: (1,4) 往4行x2列 → rows 1-4, cols 4-5
    (1,4,3),(1,5,4),(2,4,1),(2,5,2),(3,4,3),(3,5,4),(4,4,1),(4,5,2),
    # Block 4: (6,4) 往3行x2列 → rows 6-8, cols 4-5
    (6,4,3),(6,5,4),(7,4,1),(7,5,2),(8,4,3),(8,5,4),
    # Block 5: (1,7) 往4行x2列 → rows 1-4, cols 7-8
    (1,7,1),(1,8,2),(2,7,3),(2,8,4),(3,7,1),(3,8,2),(4,7,3),(4,8,4),
    # Block 6: (6,7) 往3行x2列 → rows 6-8, cols 7-8
    (6,7,1),(6,8,2),(7,7,3),(7,8,4),(8,7,1),(8,8,2),
]
...
ROBOT_COLORS = [
    ...
    "#ff3333", "#33ff99", "#3399ff", "#ffff33",
    # 第二组 14
    "#ff33cc", "#33ffff", "#cc9933", "#9933cc", "#33cc66", "#6633ff",
    "#ff6699", "#66ff99", "#9966ff", "#ff9966", "#66ffcc", "#cc66ff",
    "#ffcc66", "#66ccff",
    # 第三组 14
    "#ff4400", "#00ff44", "#4400ff", "#ffaa00", "#00ffaa", "#aa00ff",
    "#ff0044", "#44ff00", "#0044ff", "#ff00aa", "#aaff00", "#00aaff",
    "#884400", "#008844",
]
POD_COLORS = [
    # 第一组 14
    ...
    "#44ffaa", "#ff4444", "#4488ff", "#ddff44",
    # 第二组 14
    "#ff44aa", "#44dddd", "#ddaa44", "#aa44dd", "#44dd88", "#8844ff",
    "#ff8844", "#44ff88", "#8844cc", "#ccff44", "#44ccaa", "#aa44cc",
    "#ffcc88", "#88ccff",
    # 第三组 14
    "#ff6600", "#00ff66", "#6600ff", "#ffbb00", "#00ffbb", "#bb00ff",
    "#ff0066", "#66ff00", "#0066ff", "#ff00bb", "#bbff00", "#00bbff",
    "#996633", "#339966",
]
